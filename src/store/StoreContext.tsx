...
import { appReducer, initialState, State, Action, CartItem } from './reducer'
...
interface StoreContextValue {
  ...
  clearCart: () => void
  setComponents: (comps: SelectedComponentsMap) => void
...
export function StoreProvider({ children }: { children: ReactNode }) {
  ...
  const setComponents = useCallback((comps: SelectedComponentsMap) => dispatch({ type: 'SET_COMPONENTS', payload: comps }), [])
