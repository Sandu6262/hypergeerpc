    ...
    <div className="fans-bg" aria-hidden="true">
      <svg viewBox="0 0 520 470" xmlns="http://www.w3.org/2000/svg" className="fans-svg">
        ...
        <rect x="110" y="10" width="260" height="185" rx="10"
          fill="rgba(8,8,20,.88)" stroke="rgba(0,255,208,.3)" strokeWidth="1.2"/>
        <rect x="118" y="18" width="244" height="160" rx="4"
          fill="rgba(2,2,12,.92)" className="screen-bg"/>
        <rect x="118" y="18" width="244" height="160" rx="4"
          fill="none" stroke="rgba(0,255,208,.12)" strokeWidth=".5"/>

        {/* HUD bars */}
        <rect x="127" y="27" width="72" height="5" rx="2" fill="rgba(0,255,208,.1)"/>
        <rect x="127" y="27" width="50" height="5" rx="2" fill="rgba(0,255,208,.5)" className="hud-fill hud-fill-1"/>
        ...
        {/* Crosshair */}
        <line x1="240" y1="90" x2="240" y2="108" stroke="rgba(0,255,208,.35)" strokeWidth="1"/>
        <line x1="231" y1="99" x2="249" y2="99" stroke="rgba(0,255,208,.35)" strokeWidth="1"/>
        <circle cx="240" cy="99" r="7" fill="none" stroke="rgba(0,255,208,.2)" strokeWidth=".7"/>
        ...
        <rect x="110" y="195" width="260" height="10" rx="0"
          fill="rgba(6,6,18,.9)" stroke="rgba(0,255,208,.12)" strokeWidth=".5"/>
        <circle cx="240" cy="200" r="2.5" fill="rgba(0,255,208,.9)" className="power-led"/>

        {/* Stand */}
        <rect x="228" y="205" width="24" height="32" rx="2"
          fill="rgba(8,8,20,.9)" stroke="rgba(0,255,208,.15)" strokeWidth=".7"/>
        <rect x="188" y="235" width="104" height="10" rx="5"
          fill="rgba(8,8,20,.9)" stroke="rgba(0,255,208,.18)" strokeWidth=".7"/>
        ...
        <rect x="58" y="294" width="406" height="140" rx="8"
          fill="rgba(6,6,18,.82)" stroke="rgba(0,255,208,.2)" strokeWidth=".8"/>
        <rect x="60" y="296" width="402" height="136" rx="7"
          fill="none" stroke="rgba(0,255,208,.04)" strokeWidth=".4"/>
        ...
        <rect x="493" y="330" width="8" height="14" rx="4"
          fill="rgba(0,255,208,.15)" stroke="rgba(0,255,208,.4)" strokeWidth=".7"
          className="scroll-wheel"/>
        <rect x="473" y="358" width="5" height="10" rx="2"
          fill="rgba(0,255,208,.1)" stroke="rgba(0,255,208,.2)" strokeWidth=".5"/>
        <circle cx="498" cy="395" r="2" fill="rgba(0,255,208,.6)" className="power-led"/>
