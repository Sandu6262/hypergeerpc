    ...
    <div className="fans-bg" aria-hidden="true">
      <svg viewBox="0 0 540 470" xmlns="http://www.w3.org/2000/svg" className="fans-svg">
        ...
        <rect x="110" y="10" width="260" height="185" rx="10"
          fill="rgba(5,5,5,.88)" stroke="rgba(255,215,0,.3)" strokeWidth="1.2"/>
        <rect x="118" y="18" width="244" height="160" rx="4"
          fill="rgba(3,3,3,.92)" className="screen-bg"/>
        <rect x="118" y="18" width="244" height="160" rx="4"
          fill="none" stroke="rgba(255,215,0,.12)" strokeWidth=".5"/>

        {/* HUD bars */}
        <rect x="127" y="27" width="72" height="5" rx="2" fill="rgba(255,215,0,.1)"/>
        <rect x="127" y="27" width="50" height="5" rx="2" fill="rgba(255,215,0,.5)" className="hud-fill hud-fill-1"/>
        ...
        <text x="354" y="31" textAnchor="end" fontSize="10" fontFamily="monospace"
          fill="rgba(255,215,0,.7)" className="fps-text">144 FPS</text>
        <text x="354" y="42" textAnchor="end" fontSize="7" fontFamily="monospace"
          fill="rgba(255,215,0,.35)">1440p · MAX</text>

        {/* Crosshair */}
        <line x1="240" y1="90" x2="240" y2="108" stroke="rgba(255,215,0,.35)" strokeWidth="1"/>
        <line x1="231" y1="99" x2="249" y2="99" stroke="rgba(255,215,0,.35)" strokeWidth="1"/>
        <circle cx="240" cy="99" r="7" fill="none" stroke="rgba(255,215,0,.2)" strokeWidth=".7"/>

        {/* Scan line */}
        <rect x="118" y="18" width="244" height="2"
          fill="rgba(255,215,0,.04)" className="scan-line"/>

        {/* Bottom bezel */}
        <rect x="110" y="195" width="260" height="10" rx="0"
          fill="rgba(4,4,4,.9)" stroke="rgba(255,215,0,.12)" strokeWidth=".5"/>
        <circle cx="240" cy="200" r="2.5" fill="rgba(255,215,0,.9)" className="power-led"/>

        {/* Stand */}
        <rect x="228" y="205" width="24" height="32" rx="2"
          fill="rgba(5,5,5,.9)" stroke="rgba(255,215,0,.15)" strokeWidth=".7"/>
        <rect x="188" y="235" width="104" height="10" rx="5"
          fill="rgba(5,5,5,.9)" stroke="rgba(255,215,0,.18)" strokeWidth=".7"/>
        ...
        <rect x="58" y="294" width="406" height="140" rx="8"
          fill="rgba(4,4,4,.82)" stroke="rgba(255,215,0,.2)" strokeWidth=".8"/>
        <rect x="60" y="296" width="402" height="136" rx="7"
          fill="none" stroke="rgba(255,215,0,.04)" strokeWidth=".4"/>
              ...
              return (
                <g key={`${ri}-${ki}`}>
                  ...
                  <rect x={kx} y={r.y} width={key.w} height={KH} rx="3"
                    fill="rgba(255,215,0,.04)" stroke="rgba(255,215,0,.18)" strokeWidth=".6"
        ...
        <path d="M 476 340 Q 476 322 490 320 Q 512 318 518 330 Q 524 342 522 374 Q 520 400 498 402 Q 476 402 474 374 Q 472 356 476 340 Z"
          fill="rgba(5,5,5,.88)" stroke="rgba(255,215,0,.25)" strokeWidth="1"
          className="mouse-body"/>
        <line x1="498" y1="320" x2="497" y2="350"
          stroke="rgba(255,215,0,.2)" strokeWidth=".7"/>
        <rect x="493" y="330" width="8" height="14" rx="4"
          fill="rgba(255,215,0,.15)" stroke="rgba(255,215,0,.4)" strokeWidth=".7"
          className="scroll-wheel"/>
        <rect x="473" y="358" width="5" height="10" rx="2"
          fill="rgba(255,215,0,.1)" stroke="rgba(255,215,0,.2)" strokeWidth=".5"/>
        <circle cx="498" cy="395" r="2" fill="rgba(255,215,0,.6)" className="power-led"/>
